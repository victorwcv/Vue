  ...
  <div class="flex justify-center items-center">
    <div class="">
      <div class="text-center font-semibold">
        <h1 class="text-5xl">
          <span class="text-victor-400 tracking-wide">Flexible </span>
          <span>Plans</span>
        </h1>
      ...
      <div class="pt-24 flex flex-row">
        ...
        <div class="w-96 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl">
          ...
          <div class="pt-8">
            ...
            <a href="#" class="">
              <p class="w-full py-4 bg-victor-400 mt-8 rounded-xl text-white">
        ...
        >
          ...
          <div class="absolute top-4 right-4">
            <p
              class="bg-victor-400 font-semibold px-4 py-1 rounded-full uppercase text-xs"
            >
              Popular
            </p>
          </div>
